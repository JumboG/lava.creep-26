...
-(IBAction)selectPhotoButtonClicked
{
  ...
  //  scroll.scrollEnabled = FALSE;
    ...
    UIActionSheet *popupQuery = [[[UIActionSheet alloc] initWithTitle:@"MINETATT" delegate:self cancelButtonTitle:@"Cancel Button" destructiveButtonTitle:@"Camera" otherButtonTitles:@"Library", nil]autorelease];
